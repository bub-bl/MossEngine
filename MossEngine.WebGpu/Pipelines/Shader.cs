...
namespace MossEngine.WebGpu.Pipelines;
...
public readonly unsafe struct ShaderHandle : IDisposable
{
	...
	public void Dispose()
	{
		WebGpuApi.Wgpu.ShaderModuleRelease( _module );
	}
}
...
internal static class ShaderUtility
{
	public static unsafe ShaderModule* CreateShaderModule( string shaderCode, WebGpuDevice device )
	{
		...
		var shaderModule = WebGpuApi.Wgpu.DeviceCreateShaderModule( device, in shaderModuleDescriptor );
