...
public partial struct Vector2 : System.IEquatable<Vector2>, IParsable<Vector2>, IInterpolator<Vector2>
{
	...
	{
		return new Vector2( System.Math.Clamp( x, otherMin.x, otherMax.x ), System.Math.Clamp( y, otherMin.y, otherMax.y ) );
	}
	...
	{
		var a = new Vector2( System.Math.Min( min.x, max.x ), System.Math.Min( min.y, max.y ) );
		var b = new Vector2( System.Math.Max( min.x, max.x ), System.Math.Max( min.y, max.y ) );
