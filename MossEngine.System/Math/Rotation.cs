...
/// Unlike <see cref="MossEngine.UI.Math.Angles"/>, this cannot store multiple revolutions around an axis.
/// </summary>
...
public struct Rotation : System.IEquatable<Rotation>, IParsable<Rotation>, IInterpolator<Rotation>
{
	...
	public readonly Angles Angles()
	{
		...
		a.pitch = MathF.Asin( System.Math.Clamp( -m13, -1f, 1f ) ).RadianToDegree();

		if ( System.Math.Abs( m13 ).AlmostEqual( 1f ) )
		{
	...
	public readonly float Pitch()
	{
		...
		return MathF.Asin( System.Math.Clamp( -m13, -1f, 1f ) ).RadianToDegree();
	}
