...
namespace MossEngine.UI.Utility
{
	...
	internal ref struct Parse
	{
		...
		/// </para>
		/// </summary>
		internal bool TryReadPositionAndSize( out Length positionX, out Length positionY, out Length sizeX, out Length sizeY )
		{
			// Initial values
			positionX = 0;
			positionY = 0;
			sizeX = Math.Length.Auto;
			sizeY = Math.Length.Auto;
		...
		public int CurrentLine
		{
			get
			{
				var substr = Text.Substring( 0, System.Math.Min( Pointer, Text.Length ) );
