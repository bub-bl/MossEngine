...
public struct YogaValue
{
	...
	{
		return new YogaValue { Value = value.value, Unit = (YogaUnit)value.unit };
	}

	internal static YGValue ToYGValue( YogaValue value )
	{
		return new YGValue { value = value.Value, unit = (YGUnit)value.Unit };
	}

	public static readonly YogaValue Auto = new() { Value = 0, Unit = YogaUnit.Auto };
	public static readonly YogaValue Undefined = new() { Value = YG.YGUndefined, Unit = YogaUnit.Undefined };
