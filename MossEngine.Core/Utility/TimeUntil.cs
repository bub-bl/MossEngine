...
public struct TimeUntil : IEquatable<TimeUntil>
{
	...
	/// </summary>
	public float Fraction => System.Math.Clamp( (Time.Now - _startTime) / (_time - _startTime), 0.0f, 1.0f );
	...
	public readonly bool Equals( TimeUntil o ) => System.Math.Abs( _time - o._time ) < 0.0001f;
